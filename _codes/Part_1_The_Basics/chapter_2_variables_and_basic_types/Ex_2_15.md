<!DOCTYPE html><html><head><title>Ex_2_15</title>
<meta property="og:title" content="Ex_2_15" /><meta property="og:locale" content="en_US" /><meta property="og:type" content="website" /><meta name="twitter:card" content="summary" /><meta property="twitter:title" content="Ex_2_15"/><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","headline":"Ex_2_15","url":"/Ex_2_15.md"}</script>
<main><header>
            <aside>
                <h1>Index</h1>
            <ul>
...
<<div class="code-container">### Exercise 2.15: Which of the following definitions, if any, are invalid? Why?    (a) int ival = 1.01;        //  ok     (b) int &rval1 = 1.01;      //  error : literals cannot be binded    (c) int &rval2 = ival;      //  ok    (d) int &rval3;             //  error : reference has to initialised, cannot be empty</div></div></main><footer> 
