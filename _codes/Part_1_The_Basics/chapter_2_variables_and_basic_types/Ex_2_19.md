<!DOCTYPE html><html><head><title>Ex_2_19</title>
<meta property="og:title" content="Ex_2_19" /><meta property="og:locale" content="en_US" /><meta property="og:type" content="website" /><meta name="twitter:card" content="summary" /><meta property="twitter:title" content="Ex_2_19"/><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","headline":"Ex_2_19","url":"/Ex_2_19.md"}</script>
<main><header>
            <aside>
                <h1>Index</h1>
            <ul>
...
<<div class="code-container">### Exercise 2.19: Explain the key differences between pointers and references.    references                              pointers    -----------------------------------------------------------------    * reference is not an object           * pointer is a object    * reference cannot be empty, it        * pointers can be uninitialised      has to be initialised with an       object    * reference cannot be rebinded or      * pointers can be assigned and copied      refer another object</div></div></main><footer> 
