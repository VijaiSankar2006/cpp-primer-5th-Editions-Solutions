...
<<div class="code-container">### Exercise 2.6: What, if any, are the differences between the following definitions:           int month = 9, day = 7;     // decimal literals    int month = 09, day = 07;   // octal literals</div></main><footer> 
    <nav class="footer">
        <ul>
