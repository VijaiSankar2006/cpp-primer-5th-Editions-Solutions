...
<<div class="code-container">###  Exercise 3.11: Is the following range for legal? If so, what is the type of c?const string s = "Keep out!";    for (auto &c : s) { /* ... */ }  // legal : type of s is 'const string', so deduces the type as const char    </div></main><footer> 
    <nav class="footer">
        <ul>
