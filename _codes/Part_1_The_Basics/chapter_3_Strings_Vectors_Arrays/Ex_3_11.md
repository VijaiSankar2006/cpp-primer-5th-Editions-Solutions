<!DOCTYPE html><html><head><title>Ex_3_11</title>
<meta property="og:title" content="Ex_3_11" /><meta property="og:locale" content="en_US" /><meta property="og:type" content="website" /><meta name="twitter:card" content="summary" /><meta property="twitter:title" content="Ex_3_11"/><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","headline":"Ex_3_11","url":"/Ex_3_11.md"}</script>
<main><header>
            <aside>
                <h1>Index</h1>
            <ul>
...
<<div class="code-container">###  Exercise 3.11: Is the following range for legal? If so, what is the type of c?const string s = "Keep out!";    for (auto &c : s) { /* ... */ }  // legal : type of s is 'const string', so deduces the type as const char    </div></div></main><footer> 
