...
<<div class="code-container">### Exercise 3.9: What does the following program do? Is it valid? If not, why not?    string s;    cout << s[0] << endl    //  subscripting an empty string results in to undefined behaviour</div></main><footer> 
    <nav class="footer">
        <ul>
