...
<<div class="code-container">### Exercise 4.2: Using Table 4.12 (p. 166), parenthesize the following expressions to indicate the order in which the    operands are grouped:       (a) * vec.begin()       //  * ( (vec.begin) () )     (b) * vec.begin() + 1   // ( (* ( (vec.begin) () ) ) + 1 )</div></main><footer> 
    <nav class="footer">
        <ul>
