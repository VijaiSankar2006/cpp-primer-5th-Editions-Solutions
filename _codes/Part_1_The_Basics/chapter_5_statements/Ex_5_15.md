<!DOCTYPE html><html><head><title>Ex_5_15</title>
<meta property="og:title" content="Ex_5_15" /><meta property="og:locale" content="en_US" /><meta property="og:type" content="website" /><meta name="twitter:card" content="summary" /><meta property="twitter:title" content="Ex_5_15"/><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","headline":"Ex_5_15","url":"/Ex_5_15.md"}</script>
<main><header>
            <aside>
                <h1>Index</h1>
            <ul>
...
<<div class="code-container">### Exercise 5.15: Explain each of the following loops. Correct any problems you detect.    (a) for (int ix = 0; ix != sz; ++ix) { /* . . . */ }        //  ix should be declared outsid as it is used outside for        if (ix != sz)        // . . .    (b) int ix;                                                 // ix should be initialised        for (ix != sz; ++ix) { /* . . . */ }                    // null statement should be used as init statement    (c) for (int ix = 0; ix != sz; ++ix, ++ sz) { /* . . . */ } // indefinite loop, sz shouldn't be modified</div></div></main><footer> 
