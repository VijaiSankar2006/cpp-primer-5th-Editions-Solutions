...
<<div class="code-container">### Exercise 5.2: What is a block? When might you might use a block?    A block is a sequence of statements enclosed with in a pair of curly braces     a block is used where a single statement is expected like for/if/while etc    </div></main><footer> 
    <nav class="footer">
        <ul>
