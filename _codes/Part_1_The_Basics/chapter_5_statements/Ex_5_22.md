...
<<div class="code-container">###  Exercise 5.22: The last example in this section that jumped back to begin could be better written using a loop. Rewrite the code to eliminate the goto    int sz;    do{         sz = get_size();    }while(sz <= 0);</div></main><footer> 
    <nav class="footer">
        <ul>
