<!DOCTYPE html><html><head><title>Ex_6_13</title>
<meta property="og:title" content="Ex_6_13" /><meta property="og:locale" content="en_US" /><meta property="og:type" content="website" /><meta name="twitter:card" content="summary" /><meta property="twitter:title" content="Ex_6_13"/><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","headline":"Ex_6_13","url":"/Ex_6_13.md"}</script>
<main><header>
            <aside>
                <h1>Index</h1>
            <ul>
...
<<div class="code-container">###  Exercise 6.13: Assuming T is the name of a type, explain the difference between a function declared as void f(T) and void f(T&)     void f(T)  // call by value, initialises the parameter with the copy of the argument's value, any change in the parameter's value has no impact in the argument's value     void f(T&)  // call by reference, parameter is a reference, so it gets bound to whatever argument we pass, any change in the parameter's value is the change in the argument's value as parameter is alias name to the argument</div></div></main><footer> 
