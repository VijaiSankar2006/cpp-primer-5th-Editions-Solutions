<!DOCTYPE html><html><head><title>Ex_6_28</title>
<meta property="og:title" content="Ex_6_28" /><meta property="og:locale" content="en_US" /><meta property="og:type" content="website" /><meta name="twitter:card" content="summary" /><meta property="twitter:title" content="Ex_6_28"/><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","headline":"Ex_6_28","url":"/Ex_6_28.md"}</script>
<main>
    <aside>
      <ul>
...
<<div class="code-container">### Exercise 6.28: In the second version of error_msg that has an ErrCode parameter,what is the type of elem in the for loop?    void error_msg(ErrCode e, initializer_list<string> il)    {        cout << e.msg() << ": ";        for (const auto &elem : il)        cout << elem << " " ;        cout << endl;    }    elem is reference to const string</div></main><footer> 
    <nav class="footer">
        <ul>
