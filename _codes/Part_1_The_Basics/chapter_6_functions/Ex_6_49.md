<!DOCTYPE html><html><head><title>Ex_6_49</title>
<meta property="og:title" content="Ex_6_49" /><meta property="og:locale" content="en_US" /><meta property="og:type" content="website" /><meta name="twitter:card" content="summary" /><meta property="twitter:title" content="Ex_6_49"/><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","headline":"Ex_6_49","url":"/Ex_6_49.md"}</script>
<main><header>
            <aside>
                <h1>Index</h1>
            <ul>
...
<<div class="code-container">### Exercise 6.49: What is a candidate function? What is a viable function?> candidate functions :- the list of overloaded functions whose name matches with the function name used in the call> viable functions :- the list of candidate functions, for which, the number are arguments are same, the type of the argument either matches with the type of parameter or a conversion exists to the type of parameter</div></div></main><footer> 
