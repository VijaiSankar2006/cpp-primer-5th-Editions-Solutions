<!DOCTYPE html><html><head><title>Ex_6_54</title>
<meta property="og:title" content="Ex_6_54" /><meta property="og:locale" content="en_US" /><meta property="og:type" content="website" /><meta name="twitter:card" content="summary" /><meta property="twitter:title" content="Ex_6_54"/><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","headline":"Ex_6_54","url":"/Ex_6_54.md"}</script>
<main><header>
            <aside>
                <h1>Index</h1>
            <ul>
...
<<div class="code-container">###  Exercise 6.54: Write a declaration for a function that takes two int parameters and returns an int, and declare a vector whose elements have this function pointer type.    int fuction(int, int);   // function declaration    typedef int (*fp)(int , int);  //  fp is pointer to function, declared by using typedef    using fp = int (*) (int, int); //  fp is pointer to function, declared using 'using'    typedef decltype(function) *fp  // f is pointer to function, declared using decltype    std::vector<fp> fpvec;    // fpvec is a vector of type fp, which is a pointer to function which takes two int                                  parameteres and returns a int type</div></div></main><footer> 
