<!DOCTYPE html><html><head><title>Ex_7_54</title>
<meta property="og:title" content="Ex_7_54" /><meta property="og:locale" content="en_US" /><meta property="og:type" content="website" /><meta name="twitter:card" content="summary" /><meta property="twitter:title" content="Ex_7_54"/><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","headline":"Ex_7_54","url":"/Ex_7_54.md"}</script>
<main><header>
            <aside>
                <h1>Index</h1>
            <ul>
...
<<div class="code-container">### Exercise 7.54: Should the members of Debug that begin with set_ be declared as constexpr? If not, why not?    constexpr types are implicitly constant, so we cannot declare a function as constexpr which changes the state of a obj. </div></div></main><footer> 
