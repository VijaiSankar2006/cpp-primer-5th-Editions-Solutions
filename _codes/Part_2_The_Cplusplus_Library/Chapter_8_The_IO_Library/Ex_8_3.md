...
<<div class="code-container">### Exercise 8.3: What causes the following while to terminate?    while (cin >> i) /* ... */    invalid input and eof will cause while to terminate</div></main><footer> 
    <nav class="footer">
        <ul>
