<!DOCTYPE html><html><head><title>Ex_2_11</title>
<meta property="og:title" content="Ex_2_11" /><meta property="og:locale" content="en_US" /><meta property="og:type" content="website" /><meta name="twitter:card" content="summary" /><meta property="twitter:title" content="Ex_2_11"/><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","headline":"Ex_2_11","url":"/Ex_2_11.md"}</script>
<main><header>
            <aside>
                <h1>Index</h1>
            <ul>
...
<<div class="code-container">### Exercise 2.11: Explain whether each of the following is a declaration or a definition:    (a) extern int ix = 1024;   // definition( outside any function) overrides extern, error( specified inside in a function )    (b) int iy;                 // definition    (c) extern int iz;          // declaration    </div></div></main><footer> 
