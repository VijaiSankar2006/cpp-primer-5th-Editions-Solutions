<!DOCTYPE html><html><head><title>Ex_2_14</title>
<meta property="og:title" content="Ex_2_14" /><meta property="og:locale" content="en_US" /><meta property="og:type" content="website" /><meta name="twitter:card" content="summary" /><meta property="twitter:title" content="Ex_2_14"/><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","headline":"Ex_2_14","url":"/Ex_2_14.md"}</script>
<main><header>
            <aside>
                <h1>Index</h1>
            <ul>
...
<<div class="code-container">### Exercise 2.14: Is the following program legal? If so, what values are printed?    int i = 100, sum = 0;    for (int i = 0; i != 10; ++i)        sum += i;    std::cout << i << " " << sum << std::endl;       // 100 45, as 'i' defined in 'for' hides the 'i' in the outer scope                                                         and its scope ends with 'for' </div></div></main><footer> 
