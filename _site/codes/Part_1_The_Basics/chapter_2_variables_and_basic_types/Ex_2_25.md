<!DOCTYPE html><html><head><title>Ex_2_25</title>
<meta property="og:title" content="Ex_2_25" /><meta property="og:locale" content="en_US" /><meta property="og:type" content="website" /><meta name="twitter:card" content="summary" /><meta property="twitter:title" content="Ex_2_25"/><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","headline":"Ex_2_25","url":"/Ex_2_25.md"}</script>
<main><header>
            <aside>
                <h1>Index</h1>
            <ul>
...
<<div class="code-container">### Exercise 2.25: Determine the types and values of each of the following variables.    (a) int* ip, i, &r = i;   //  ip is a pointer to int, i is an int, r is a reference to an int type i     (b) int i, *ip = 0;       //  i is int, ip is a pointer to int and initialised to nullptr      (c) int* ip, ip2;         //  ip is a pointer to int, ip2 is an int  </div></div></main><footer> 
