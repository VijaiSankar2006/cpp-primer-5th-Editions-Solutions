<!DOCTYPE html><html><head><title>Ex_3_33</title>
...
<<div class="code-container">### Exercise 3.33: What would happen if we did not initialize the scores array in the program on page 116?**unnitialised** array of *built-in type* defined inside any function will have **undefined values**.</div></main><footer> 
    <nav class="footer">
        <ul>
