<!DOCTYPE html><html><head><title>Ex_3_9</title>
<meta property="og:title" content="Ex_3_9" /><meta property="og:locale" content="en_US" /><meta property="og:type" content="website" /><meta name="twitter:card" content="summary" /><meta property="twitter:title" content="Ex_3_9"/><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","headline":"Ex_3_9","url":"/Ex_3_9.md"}</script>
<main><header>
            <aside>
                <h1>Index</h1>
            <ul>
...
<<div class="code-container">### Exercise 3.9: What does the following program do? Is it valid? If not, why not?    string s;    cout << s[0] << endl    //  subscripting an empty string results in to undefined behaviour</div></div></main><footer> 
