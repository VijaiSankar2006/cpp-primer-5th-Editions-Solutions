<!DOCTYPE html><html><head><title>Ex_4_37</title>
<meta property="og:title" content="Ex_4_37" /><meta property="og:locale" content="en_US" /><meta property="og:type" content="website" /><meta name="twitter:card" content="summary" /><meta property="twitter:title" content="Ex_4_37"/><script type="application/ld+json">{"@context":"https://schema.org","@type":"WebPage","headline":"Ex_4_37","url":"/Ex_4_37.md"}</script>
<main><header>
            <aside>
                <h1>Index</h1>
            <ul>
...
<<div class="code-container">### Exercise 4.37: Rewrite each of the following old-style casts to use a named cast:    int i; double d; const string *ps; char *pc; void *pv;    (a) pv = (void*)ps;         pv = const_cast<void *>(static_cast<const void *>(ps));     (b) i = int(*pc);         i = static_cast<int>(*pc);    (c) pv = &d;         pv = &d    (d) pc = (char*) pv;        pc = static_cast<char *>(pv)</div></div></main><footer> 
