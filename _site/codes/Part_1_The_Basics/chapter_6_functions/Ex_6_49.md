...
<<div class="code-container">### Exercise 6.49: What is a candidate function? What is a viable function?> candidate functions :- the list of overloaded functions whose name matches with the function name used in the call> viable functions :- the list of candidate functions, for which, the number are arguments are same, the type of the argument either matches with the type of parameter or a conversion exists to the type of parameter</div></main><footer> 
    <nav class="footer">
        <ul>
